...
$heroStyle = 'min-height: 50vh; background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 50%, #a855f7 100%);';
...
$heroTitle = $sectionConfig['header_title'] ?? 'Ministerio de Jóvenes';
$heroSubtitle = $sectionConfig['header_subtitle'] ?? 'Energía, pasión y propósito en Cristo. Una generación que no se avergüenza del evangelio.';
?>
        ...
        <div class="row align-items-center justify-content-center text-center" style="min-height: 50vh;">
            <div class="col-lg-8 hero-content" data-aos="fade-up">
                <div class="section-hero-logo">
                    <img src="<?= BASE_URL ?>/uploads/logos/logojovenes.png" alt="Logo Jóvenes" class="site-logo section-logo-image">
                </div>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right">
                <span class="badge bg-primary bg-opacity-10 text-primary mb-3 px-3 py-2 rounded-pill">
                    <i class="bi bi-lightning-fill me-1"></i> Jóvenes MCA
                </span>
                <h2 class="display-5 fw-bold mb-4">Una Generación con Propósito</h2>
                <p class="lead text-muted mb-4">
                    Creemos que los jóvenes son el presente de la iglesia, no solo el futuro. Somos una 
                    comunidad vibrante que busca a Dios con pasión y vive su fe con autenticidad.
                </p>
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="bg-gradient-primary rounded-4 p-5 text-white text-center">
                    ...
                    <p class="fw-bold mb-0">— 1 Timoteo 4:12</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-5 bg-light-gradient">
    <div class="container py-5">
        <div class="section-header" data-aos="fade-up">
            ...
            <p>Mantente al día con todo lo que sucede en nuestro ministerio</p>
        </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up">
                <div class="card blog-card h-100">
                    ...
                    <div class="card-img-top bg-gradient-primary d-flex align-items-center justify-content-center" style="height: 200px;">
                        <i class="bi bi-lightning-fill text-white display-4"></i>
                    </div>
                    <?php endif; ?>
                    <div class="card-body">
                        <div class="card-meta">
...
<section class="py-5 bg-light-gradient">
    <div class="container py-5">
        <div class="section-header" data-aos="fade-up">
            ...
            <p>Mantente conectado con las actividades del ministerio de jóvenes</p>
        </div>
        <div class="row g-4">
            <div class="col-lg-12" data-aos="fade-up">
                <div class="text-center">
                    <a href="https://www.instagram.com/solodiscipulos/" target="_blank" class="btn btn-primary btn-lg mb-4">
                        <i class="bi bi-instagram me-2"></i>Síguenos en Instagram
                    </a>
                    <div class="bg-white rounded-3 p-4 shadow-sm">
                        <iframe src="https://www.instagram.com/solodiscipulos/embed" width="100%" height="500" frameborder="0" scrolling="no" allowtransparency="true"></iframe>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-5 bg-gradient-primary text-white">
    <div class="container py-4 text-center">
        ...
        <p class="opacity-90 mb-4">Únete a nuestra familia de jóvenes comprometidos con Cristo</p>
