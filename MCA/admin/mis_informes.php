...
$informes = [];
try {
    $stmt = $pdo->prepare("SELECT * FROM informes_admin WHERE admin_id = ? AND MONTH(semana_inicio) = ? AND YEAR(semana_inicio) = ? ORDER BY semana_inicio DESC");
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= BASE_URL ?>/admin/informe.php?id=<?= $inf['id'] ?>" class="btn btn-sm btn-outline-primary">
